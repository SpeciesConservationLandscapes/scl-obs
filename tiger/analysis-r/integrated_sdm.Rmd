...
ct <- merge(tiger.CT.entry, tiger.CT.observations, 
            by.x = "deployment.ID",
            by.y = "deployment.ID")
...
###############################
# pb.occupancy - matrix with covariates that effect occupancy in the locations of detected presences of the camera trap - should be ad hoc
# pb.detection - matrix with covariates that effect detection in the locations of detected presences of the camera trap - should be ad hoc
###############################
